...
function EndContainer(){
    return <div class="endTextContainer">
        <div class="endText">
           {data.map(dat=>{
            return <div>
            <p class="heading">{dat.title}</p>
